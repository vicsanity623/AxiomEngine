...
class AxiomFormatter(logging.Formatter):
    ...
    This uses a custom formatter to assign colors and icons.
    """
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if (
            ...
            "new fact" in lower_msg
            or "success" in lower_msg
            or "created" in lower_msg
            or "identified" in lower_msg
        ):
            color = CYAN
            icon = "✓"
        elif (
            "initializing" in lower_msg
            or "starting" in lower_msg
            or "connections" in lower_msg
        ):
            color = YELLOW
            icon = "⟳"
        else:
